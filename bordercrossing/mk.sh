...
rgblink -o bordercrossing.gb -n bordercrossing.sym -m bordercrossing.map -d obj/gb/main.o obj/gb/fink.o obj/gb/sgb.o obj/gb/pads.o obj/gb/ppuclear.o obj/gb/vwf4w.o
